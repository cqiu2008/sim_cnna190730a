...
u_dsp48e2(
   ...
   //OPMODE{[8,7]=2'b0, means W out select 0
   //OPMODE[6,4]=3'b011, means Z out select C
   //OPMODE[3,2,1,0]=4'b0101},means X out ,Y out select multiplier result
   // Data inputs: Data Ports
   .A(S_weight),                      // 30-bit input: A data
   .B(S_pixel),                       // 18-bit input: B data
   .C(S_product_casi),                // 48-bit input: C data
